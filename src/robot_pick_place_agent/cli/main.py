...
def main(argv=None):
    ...
    sim = sub.add_parser("simulate"); sim.add_argument("instruction", nargs="?", default="把红色方块放进蓝色盒子"); sim.add_argument("--xml", help="可选的 PiPER/夹爪 MJCF 文件")
    ...
    if args.command == "observe":
        ...
        try:
            print(json.dumps(app.simulate(args.instruction, xml_path=args.xml), ensure_ascii=False, indent=2))
